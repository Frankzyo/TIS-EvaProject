...
import "../../../css/EstilosEvaluaciones/EvaluacionDeParesEstudiante.css";
...
const EvaluacionDeParesEstudiante = () => {
    ...
    const handleGuardarComentarioYNota = async (
        idAsignacion,
        comentario,
        calificacion
    ) => {
        ...
        if (calificacionNumerica > evaluacion.nota_maxima) {
            alert(
                `La calificación no puede exceder la nota máxima (${evaluacion.nota_maxima}).`
            );
            return;
        }
            ...
            setAsignaciones((prevAsignaciones) =>
                prevAsignaciones.map((asignacion) =>
                    asignacion.id_asignacion_par === idAsignacion
                        ? {
                              ...asignacion,
                              comentarios_y_notas: asignacion
                                  .comentarios_y_notas.length
                                                ...
                                                <div className="comentarios-section">
                                                    ...
                                                    {String(
                                                        ...
                                                        asignacion
                                                            .comentarios_y_notas
                                                            ?.length > 0 ? (
                                                            asignacion.comentarios_y_notas.map(
                                                                (
                                                                    comentarioNota,
                                                                    index
                                                                ) => (
                                                                    <div
                                                                        ...
                                                                        className="comentario-item mejorado"
                                                                    >
